...
// TESTANDO CONEXÃO COM O MONGO DB

var config = require('config.json');
var mongoose = require('mongoose');

try {
    mongoose.connect(config.connectionString, {reconnectTries: Number.MAX_VALUE, reconnectInterval: 500, poolSize: 5, useNewUrlParser: true});
...
api.use('/api/ask', require('./controllers/api/ask.controller'));
